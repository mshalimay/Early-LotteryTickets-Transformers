...
# ./lib/python3.10/site-packages/transformers/pytorch_utils.py
...
def find_pruneable_heads_and_indices(
    heads: List[int], n_heads: int, head_size: int, already_pruned_heads: Set[int], nn_mod=None
    ...
    #NOTE @modif
    if nn_mod and nn_mod.self.self_slimming:
        slimming_mask = torch.ones(nn_mod.self.num_attention_heads)
    ...
    if nn_mod and nn_mod.self.self_slimming:
        return heads, index, slimming_mask, slimming_index
