...
class ViTAttention(nn.Module):
    ...
    def prune_heads(self, heads: Set[int]) -> None:
        ...
        heads, index, slimming_index = find_pruneable_heads_and_indices(
            heads, self.attention.num_attention_heads, self.attention.attention_head_size, self.pruned_heads, nn_mod=self.self
        )
...
class ViTLayer(nn.Module):
    ...
    def forward(
        ...
        if self.slimming:
            layer_output = layer_output * self.slimming_coef
